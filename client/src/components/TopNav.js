    ...
    <div className='max-w-[1520] mx-auto flex justify-between items-center p-4'>
      {/*Menu button and Title*/}
        <div className='flex items-center'>
            ...
            <h1 className='text-2xl sm:text-3xl lg:text-4xl mx-2'>Yum
            <span className='font-bold'>Eats</span>
            </h1>
            <div className='hidden lg:flex items-center bg-gray-200 rounded-full p-1 text-[14px] mx-1'>
                <p className='bg-orange-700 text-white rounded-full px-2 py-1 text-bold'>Free</p>
                <p className='px-2 py-1 text-bold'>Delivery</p>
            </div>
        </div>
      {/*Search*/}
            ...
            <nav>
              <ul className='flex flex-col p-4 text-gray-900'>
                <li className='text-xl py-4 flex'>
                  <BsPerson size={25} 
                  className='mr-4 p-1 text-white bg-black rounded-full'
                  />My Account
                </li>
                <li className='text-xl py-4 flex'>
